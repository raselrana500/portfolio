<footer id="footer">
    <div class="container">
      <h3 class="btn btn-danger"> Rasel Rana </h3>
      <p>I hereby declare that all the information above is correct.</p>
      ...
      <div class="copyright">
        &copy; Copyright <?php echo date('Y'); ?> <strong><span> Rasel Rana</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Design And Developted by <a target="blank" href="https://www.facebook.com/raselranacse">Rasel Rana</a>
      </div>
    </div>
  </footer>